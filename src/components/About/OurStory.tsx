    ...
    <section className="w-full h-full my-[2rem] xl:my-[5rem] px-7">
      <div className="h-full w-full flex items-end relative">
          ...
          <div className="flex flex-col gap-y-16">
            ...
            <div className="w-full flex flex-col xl:flex-row">
              ...
              >
                <Image
                  src={mockup}
                  alt="Whipcare founders story - car care platform mockup"
              ...
              <div className="xl:w-1/2 xl:pl-20 pr-5 flex flex-col gap-y-2">
                <h2 className="text-[#FC4B37] text-[20px] font-medium pl-6 xl:pl-7 pt-3 xl:pt-0">
                  Whipcare
                </h2>
                    ...
                    <div key={index} className="flex">
                      <div>
                        <div className="flex items-center gap-x-2">
                          ...
                          <h3 className="text-gray-900 text-[25px] font-semibold">
                            {item.title}
                          </h3>
                        </div>
                        <p className="text-sm text-gray-500 font-light pl-7">
                          {item.description}
                        </p>
                      </div>
                    </div>
          ...
          <div className="h-full flex flex-col gap-y-7">
            ...
            <div className="w-full h-full flex flex-col xl:flex-row-reverse">
              ...
              >
                <Image
                  src={missionMockup}
                  alt="Whipcare mission and vision section mockup"
                  className="w-full h-full"
                />
              </motion.div>
        ...
        <div className="hidden xl:block absolute">
          <Image
            src={ellipse}
            alt="Whipcare about section decorative ellipse"
            className="w-[30rem]"
          />
        </div>
      </div>
