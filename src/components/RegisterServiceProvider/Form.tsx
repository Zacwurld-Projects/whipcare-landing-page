                    ...
                    <div className='xl:w-1/2 bg-white xl:pl-[5rem] px-7 xl:px-0 py-[2rem] xl:rounded-l-[3rem]'>
                        <div className="w-full h-full flex flex-col justify-center items-start gap-y-7">
                            <div className='flex flex-col gap-y-2'>
                                ...
                                <p className='text-gray-500 text-sm xl:w-2/3'>Register as a service provider and be the first to get notified when we launch.</p>
                            </div>
                            <div className='w-full flex flex-col gap-y-4'>
                                ...
                                <button className='bg-brand-500 w-full flex justify-center text-white font-medium py-2 hover:bg-brand-400'>Register</button>
                            </div>
