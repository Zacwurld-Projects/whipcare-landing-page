      ...
      <div className='w-full h-full py-10 px-10 xl:px-20'>
        <div className='w-full flex flex-col xl:flex-row gap-y-7 xl:gap-y-0'>
          <div className='xl:w-1/3 flex flex-col items-center xl:items-start'>
            ...
            <p className='text-sm text-white font-light text-center xl:text-start'>
              From mechanics to detailers, book top-rated professionals
              effortlessly. Your {"car's"} perfect partner is just a click away.
            </p>
            <Link
              href={linkTree}
              target='_blank'
              className='bg-white text-black rounded-full h-[40px] w-[150px] flex items-center justify-center mt-8 hover:bg-opacity-50'
            >
              Get the app
            </Link>
            <div className='mt-3'>
                      ...
                      <Link key={index} href={social.link} target='_blank'>
                        ...
                        >
                          <Image
                            src={social.icon}
                            alt={social.name}
                            className='w-7 h-7 mt-2 md:mt-0'
                          />
                        </motion.div>
                      </Link>
                    ))}
        ...
        <div className='w-full flex flex-col xl:flex-row justify-center gap-y-3 xl:gap-y-0 text-white text-sm text-center xl:text-start'>
          <p className='border-b-[1px] xl:border-b-0 xl:border-r-[1px] border-white pb-3 xl:pb-0 xl:pr-3'>
            © {year} Whipcare. All rights reserved.
          </p>
          <p className='pl-3'>
