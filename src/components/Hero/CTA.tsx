            ...
            <div className='w-full xl:w-1/2 h-full relative z-20 px-7 xl:px-10 py-20'>
              <div className='w-full h-full flex flex-col md:items-center xl:items-start justify-center gap-y-3'>
                <div className='flex flex-col gap-y-1'>
                  <h2 className='text-white font-semibold text-3xl capitalize'>
                    Your car, our priority
                  </h2>
                  <p className='text-white md:w-2/3 xl:w-full md:text-center xl:text-start'>
                    Sign up with your email and get informed about discounts ,
                    Whipcare tips and exciting features coming your way!
                  </p>
                </div>
                <div className='w-full flex flex-col gap-y-3'>
                  <div className='w-full flex justify-center'>
                    <div className='w-full md:w-2/3 xl:w-full h-[3rem] flex items-center md:justify-between xl:justify-between bg-white rounded-full py-1 pr-1 pl-3 mt-5 xl:mt-0'>
                      ...
                      <button
                        ...
                        }  h-full text-white text-xs px-7 rounded-full`}
                        disabled={loader}
                      >
                  ...
                  <div className='flex gap-5 mt-2 justify-center xl:justify-start'>
                    <Link
                      href={playstoreLink}
                      target='_blank'
                      className='flex items-center justify-between w-[9rem] bg-black text-white border-[1px] border-gray-500 px-3 py-2 rounded-md'
                    >
                    ...
                    <Link
                      href={appstoreLink}
                      target='_blank'
                      className='flex items-center justify-between w-[9.5rem] bg-black text-white border-[1px] border-gray-500 pl-1 pr-2 py-2 rounded-md'
                    >
