  ...
  return (
    ...
    >
      <div className="mx-auto flex w-full max-w-[1048px] flex-col items-center gap-12 sm:gap-16 lg:gap-20">
        <header className="flex max-w-[550px] flex-col items-center justify-center gap-2 text-center">
          <h2
        ...
        <div className="grid w-full max-w-[1048px] grid-cols-1 gap-6 sm:gap-8 md:grid-cols-2 md:gap-10">
          {serviceCategories.map((service) => (
            <Card
              key={service.title}
              className="min-h-[260px] rounded-2xl border-0 bg-gray-50 shadow-none sm:min-h-[300px]"
            >
