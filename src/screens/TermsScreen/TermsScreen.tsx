            ...
            <header className="relative mt-10 flex flex-col items-center px-4 sm:mt-14 sm:px-6 lg:mt-16 lg:px-[52px]">
              <div className="flex max-w-[900px] flex-col items-center gap-3 text-center sm:gap-4">
                <div className="relative inline-block opacity-0 animate-fade-up">
                  <span
                    aria-hidden="true"
                    className="absolute bottom-[6px] left-1/2 z-0 h-[14px] w-[min(100%,280px)] -translate-x-1/2 rounded-[1px] bg-[#fca5a5]/60 sm:bottom-[10px] sm:h-[18px] sm:w-[350px] lg:bottom-[14px] lg:h-5 lg:w-[400px]"
                  />
                  <h1
                    id="terms-page-title"
                ...
                >
                  Our policies for car owners, fleet operators, and service providers on the Whipcare platform.
                </p>
              </div>
            </header>
          </div>
